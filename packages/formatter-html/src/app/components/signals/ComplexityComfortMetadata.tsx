...
export default function ComplexityComfortMetadata({
  ...
  return (
    <div
      className="mt-3 pt-3 border-t border-[var(--sc-border,#e5e7eb)] cursor-default space-y-2"
    ...
    >
      {metrics.length > 0 ? (
        ...
        <p className="text-[var(--sc-text-muted,#9ca3af)] text-xs italic text-center py-2">
